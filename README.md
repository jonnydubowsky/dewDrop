...
# Quick Update
You can follow this project on [a subreddit](https://www.reddit.com/r/dewDropLanguage) I created for people to speak the dewdrop language.  Eventually i'll create a bot to process statements in that subreddit.
...
## A Flawed Version of this System Already Exists
  ...
  By speaking in a formal language, it's possible to combine millions of statements made by different people and come to solid conclusions about beliefs which are contradictory, and how much weight we should put on a stranger's words.
 ...
 * Evaluate how integrated a person's trust network is. Someone who has thousands of people who trust them, and none of them trust each other, is a very differnet kind of person who is trustled by a much smaller number of people who all trust each other.
...
# More Details
  ...
  The language can be determined by simple regular expresisons. The primitives are keyworks, hashtags, and URLs. A simple parser is implemented in `parser.py`. This is the complete specification for version 0.1 of the dewDrop language.
...
Means "The speaker of this sentence claims to be a member of the #democrat group."  Any group you want to identify with can be used as a hashtag.  This way, discussions around social movements, say "#yesAllWomen", can involve people stating their identification with principles of the group. If I choose to leave a group  - either becuase their values have changed, or I have - I can ussue a 'NOTA' statement:
  ...
  A person can also make statements about other people. I can claim that Ralph Nader is a #greenparty member:

    #ddv2 ISA #greenparty @RalphNader
...
## Statement Agreement
 ...
 I can also agree with a supreme court decision by 'agreeing' with a news article about the supreme court decision, or the Wikipedia page. 
  ...
  When a discussion evolves to a certain point, a hashtag will likely be created to represent the movement. At that point, people who agree with one 'side' of the discussion will issue a 'group memebership' statement. The point of 'agremeent' statements is primarily to allow people to agree or disagree with other people's statements.
...
Assuming that the URL above is that of Alice's original tweet.
...
## Trust and Distrust
  ...
  I can speak about others' trust or distrust using the three-part syntax. The first URL is the person who is [dis]trusted. The second is the one who does the trust/distrust. The third is a description URL; my reasoning for linking the two.

## Same Identity

    .* #ddv2 SAME (URL) (URL) [URL]

  This statement may seem small at first, but it actually gives dewDrop a lot of power. It's used to link identities together - so that I can say "this Facebook account is the same as this Twitter account", this email address belongs to this account, etc. If @Eve creates a fake account @Fred so she can troll people, and I'm certain it's @Eve pulling the strings, I can make this statement public:
...
## Thanks
  ...
  The 'THANKS' syntax follows the same pattern as 'FORGIVE' or 'HURT'. A single URL means that the speaker is saying they feel thankful to the identity at that URL. Two URLs means the speaker is saying "person A thanks person B". Three URLs mean "person A thanks person B, here are details".
